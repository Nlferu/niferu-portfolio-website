...
export default function About() {
    ...
    return (
        <motion.section
            className="max-w-[45rem] text-center sm:mb-0"
        ...
        >
            ...
            <p className="text-gray-400 font-medium">When I'm not programming I like playing blitz and bullet chess, video games or do skateboarding!</p>
        </motion.section>
    )
}
