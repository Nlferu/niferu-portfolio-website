    ...
    return (
        ...
        >
            <section className="bg-crimson max-w-[45rem] border border-wise rounded-lg overflow-hidden sm:pr-1 relative sm:h-[19.5rem] hover:bg-zinc-900 transition duration-700 sm:group-even:pl-8">
                <div className="pt-2 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-5 sm:max-w-[50%] flex justify-center flex-col h-full sm:group-even:ml-[18rem]">
                    <h3 className="text-2xl font-semibold text-gray-300 text-center sm:text-left">{title}</h3>
                    <p className="mt-2 mb-2 leading-relaxed text-gray-400 text-center sm:text-left">{description}</p>
                ...
                <Link href={href} target="_blank">
                    <Image
                        className="absolute hidden sm:block top-8 -right-[10rem] w-[28.25rem] rounded-[0.5rem] shadow-2xl group-hover:shadow-3xl duration-[0.6s]
