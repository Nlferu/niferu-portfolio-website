    ...
    return (
        <html lang="en" className="!scroll-smooth">
            ...
            <body className={`${inter.className} pt-28 sm:pt-36 bg-gray-200 dark:bg-devil`}>
                <div className="bg-[#99ffcc] dark:bg-[#671f91a8] absolute top-[1rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
                <div className="bg-[#ffff6b] dark:bg-[#48457c] absolute top-[9rem] -z-10 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]"></div>
